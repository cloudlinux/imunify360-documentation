import{_ as s,V as d,n as u,p as l,q as o,J as e,C as t,A as a,a7 as i}from"./framework-7777e868.js";const r={},c=i(`<h1 id="stand-alone-version-of-imunifyav-non-panel-generic-panel-integration" tabindex="-1"><a class="header-anchor" href="#stand-alone-version-of-imunifyav-non-panel-generic-panel-integration" aria-hidden="true">#</a> Stand-alone version of ImunifyAV(+) (non-panel, generic panel integration)</h1><p>Below you can find the steps to install and run ImunifyAV(+), in stand-alone mode, or within any hosting panel.</p><h4 id="requirements" tabindex="-1"><a class="header-anchor" href="#requirements" aria-hidden="true">#</a> Requirements</h4><p><strong>Operating system</strong></p><ul><li>CentOS/RHEL 6/7/8</li><li>CloudLinux OS 6/7/8</li><li>Ubuntu 16.04 (LTS only), 18.04, 20.04, and 22</li><li>Debian 9 (supported up to Imunify v6.11 (including)) /10/11</li><li>Rocky Linux 8</li></ul><h4 id="prerequisites" tabindex="-1"><a class="header-anchor" href="#prerequisites" aria-hidden="true">#</a> Prerequisites</h4><ul><li>PHP with <code>proc_open</code> function enabled (remove it from the <code>disable_functions</code> list in <code>php.ini</code>)</li></ul><p>There are some basic steps to run ImunifyAV as a stand-alone application:</p><ol><li>Define a way to serve web-based UI</li><li>Provide ImunifyAV with an actual list of users in the system</li><li>Configure a user authentication process</li></ol><div class="warning custom-block"><p class="custom-block-title">Warning</p><p>Imunify Web-UI PHP code has to be executed under a non-root user which has access to <code>/var/run/defence360agent/non_root_simple_rpc.sock</code>. If it runs in CageFS, you&#39;ll need to configure it accordingly.</p></div><p>To allow non-root user in CageFS access to the socket, this workaround should be applied:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code># create directory for moun-point
