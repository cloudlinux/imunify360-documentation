...
| WordPress Plugin:  <br>TablePress | 2.0.4+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>The Events Calendar | 5.0.0+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>Custom Post Type UI | 1.13.5+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>UIWidgets for Google Reviews | 10.9.1+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>Slider, Gallery, and Carousel by MetaSlider | 3.20.0+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>PixelYourSite - Your smart PIXEL | 8.0.0+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>Ocean Extra | 1.5.0+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>MetForm | 1.4.0+ | COVERAGE, COVERAGE+CLEAN | all |
| WordPress Plugin:  <br>Forminator Forms | 1.13.3+ | COVERAGE, COVERAGE+CLEAN | all |
...
| PrestaShop Plugin:  <br>Faceted Search | 3.0.1+ with PHP5.6+ | COVERAGE, COVERAGE+CLEAN | all |
