...
:::warning Note
Enabling the service immediately puts the [default settings](#default-settings) in effect for **all** traffic: any client that exceeds the default rate — initially 300 requests per minute — is served the JavaScript challenge.
:::
