import{_ as d,S as u,n as l,p as r,q as i,J as n,C as t,A as s,a2 as a}from"./framework-8c389947.js";const c={};function m(v,e){const o=u("RouterLink");return l(),r("div",null,[e[9]||(e[9]=i("h1",{id:"stand-alone-version-of-imunifyav-non-panel-generic-panel-integration",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#stand-alone-version-of-imunifyav-non-panel-generic-panel-integration","aria-hidden":"true"},"#"),n(" Stand-alone version of ImunifyAV(+) (non-panel, generic panel integration)")],-1)),e[10]||(e[10]=i("p",null,"Below you can find the steps to install and run ImunifyAV(+), in stand-alone mode, or within any hosting panel.",-1)),e[11]||(e[11]=i("h4",{id:"requirements",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#requirements","aria-hidden":"true"},"#"),n(" Requirements")],-1)),e[12]||(e[12]=i("p",null,[i("strong",null,"Operating system")],-1)),i("ul",null,[i("li",null,[e[1]||(e[1]=n("The same list as ",-1)),t(o,{to:"/imunifyav/#requirements"},{default:s(()=>e[0]||(e[0]=[n("here",-1)])),_:1,__:[0]}),e[2]||(e[2]=n(".",-1))])]),e[13]||(e[13]=a(`<h4 id="prerequisites" tabindex="-1"><a class="header-anchor" href="#prerequisites" aria-hidden="true">#</a> Prerequisites</h4><ul><li>PHP with <code>proc_open</code> function enabled (remove it from the <code>disable_functions</code> list in <code>php.ini</code>)</li></ul><p>There are some basic steps to run ImunifyAV as a stand-alone application:</p><ol><li>Define a way to serve web-based UI</li><li>Provide ImunifyAV with an actual list of users in the system</li><li>Configure a user authentication process</li></ol><div class="warning custom-block"><p class="custom-block-title">Warning</p><p>Imunify Web-UI PHP code has to be executed under a non-root user which has access to <code>/var/run/defence360agent/non_root_simple_rpc.sock</code>. If it runs in CageFS, you&#39;ll need to configure it accordingly.</p></div><p>To allow non-root user in CageFS access to the socket, this workaround should be applied:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># create directory for moun-point
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,16)),i("p",null,[e[4]||(e[4]=n("It should point to an executable file that generates a JSON file similar to the following (see details ",-1)),t(o,{to:"/stand_alone_mode/#integration-config-file"},{default:s(()=>e[3]||(e[3]=[n("here",-1)])),_:1,__:[3]}),e[5]||(e[5]=n("):",-1))]),e[14]||(e[14]=a(`<div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>{
  &quot;data&quot;: [
    {
      &quot;id&quot;: 1000,
      &quot;username&quot;: &quot;ins5yo3&quot;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="how-to-install-imunifyav" tabindex="-1"><a class="header-anchor" href="#how-to-install-imunifyav" aria-hidden="true">#</a> How to install ImunifyAV</h4><p>Now everything is ready to install ImunifyAV.</p>`,23)),i("p",null,[e[7]||(e[7]=n("The installation instructions are the same as for cPanel/DirectAdmin version, and can be found in the technical documentation: ",-1)),t(o,{to:"/imunifyav/#installation-instructions"},{default:s(()=>e[6]||(e[6]=[n("https://docs.imunifyav.com/imunifyav/#installation-instructions",-1)])),_:1,__:[6]}),e[8]||(e[8]=n(".",-1))]),e[15]||(e[15]=a(`<h4 id="how-to-open-imunifyav-ui" tabindex="-1"><a class="header-anchor" href="#how-to-open-imunifyav-ui" aria-hidden="true">#</a> How to open ImunifyAV UI</h4><p>Once ImunifyAV is installed, the web-based UI is available via the domain configured in <code>ui_path</code>.</p><p>For example, if <code>/var/www/vhosts/imav/imav.example-hosting.com/html/imav</code> is the document root folder for the imav.example-hosting.com domain, then you could open ImunifyAV with the following URL:</p><ul><li><code>https://imav.example-hosting.com/</code> (when you have TLS certificate configured for the domain) or</li><li><code>http://imav.example-hosting.com/</code></li></ul><h2 id="integration-config-file" tabindex="-1"><a class="header-anchor" href="#integration-config-file" aria-hidden="true">#</a> Integration config file</h2><p>The documentation for the ImunifyAV stand-alone version integration configuration file format.</p><p><strong>Location</strong> <code>/etc/sysconfig/imunify360/integration.conf</code></p><p><strong>Parameters</strong></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>[paths]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26))])}const h=d(c,[["render",m],["__file","index.html.vue"]]);export{h as default};
