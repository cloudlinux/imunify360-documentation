...
|[<span class="notranslate">`blocked-port`</span>](/command_line_interface/#blocked-ports)|Manages port entries|
...
|<span class="notranslate">`--ips`</span>|one or more IP addresses to block on the given port (space-separated list supported)|
